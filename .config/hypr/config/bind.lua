...
-- Resolves the native browser from the defaults module (xdg-settings detection)
local browser = require("config.defaults.browser")
...
hl.bind("SUPER + S", hl.dsp.window.fullscreen({ mode = "maximized", action = "toggle" }))
...
hl.bind(mainMod .. " + SHIFT + W", hl.dsp.exec_cmd("ags toggle wallpaper-switcher-" .. monitor))
-- # toggle user panel
